...
\EducationEntry{\textbf{Institute of Engineering \& Management, Kolkata}}{2017 - 2021 (Expected)}{Bachelor of Technology in Computer Science and Engineering. CGPA: 8.89/10}{}
...
\ExperienceEntry{\textbf{Google Summer of Code - Student}}{June, 2021 - August, 2021}{The LLVM Compiler Infrastructure Organization}{Supervisors - William Moses (MIT), Dr. Johannes Doerfert (Argonne National Laboratory)}{
    ...
    \item \href{https://enzyme.mit.edu/}{Enzyme}: LLVM Pass to perform automatic differentiation of statically analyzable LLVM IR
        \subitem - Integrate custom derivatives of Numerical Computing routines like BLAS and Eigen into Enzyme.
    \end{tightitemize}
}\vspace{1pt}\\
...
\ExperienceEntry{\textit{Supervisor} - Dr. Vassil Vassilev (Princeton University)}{November, 2019 - May, 2021}{}{\textit{Collaborations}: \href{iris-hep.org}{IRIS-HEP}, CERN ROOT Team, \href{https://compiler-research.org/}{Compiler Research group}}{
    ...
    \item \textbf{\href{https://github.com/root-project/root}{ROOT}}: An open-source data analysis framework storing over an exabyte of data
        ...
        \subitem - Fixed several rootcling bugs
    ...
    \item \textbf{\href{https://clang.llvm.org/}{Clang}}: C language family frontend for LLVM
        \subitem - Added type information to integral template arguments if required
        \subitem - Fixed type printing of template arguments
...
\Section{Talks at Public Meetings}
\vspace{-4pt}
