...
\Section{Volunter Research Experience}
\vspace{-4pt}
\ExperienceEntry{\textit{Supervisor} - Dr. Vassil Vassilev (Princeton University)}{November, 2019 - Present}{}{\textit{Collaborations}: \href{iris-hep.org}{IRIS-HEP}, CERN ROOT Team, \href{https://compiler-research.org/}{Compiler Research group}}{
    \vspace{-10pt}
    \begin{tightitemize}
    ...
    \item \textbf{\href{https://github.com/root-project/cling}{Cling}}: Interactive C++ interpreter built on top of Clang
        ...
        \subitem - Reconfigured CI
    \item \textbf{\href{https://clang.llvm.org/}{Clang}}: C language family frontend for LLVM
        \subitem - Fixed template cast and suffix printing bug (under review)
        \subitem - Fixed type printing of template arguments (under review)
...
\small{\begin{tightitemize}
    \item J.Pivarski, I.Osborne, {\textbf{P.Das}}, D.Lange, P.Elmer, {\href{https://arxiv.org/abs/2102.13516}{``AwkwardForth: accelerating Uproot with an internal DSL''}}, 25th International Conference on Computing in High-Energy and Nuclear Physics (vCHEP, 2021). \emph{[Submitted]} \hfill{2021}
