...
\Section{Preprints under submission}
\begin{tightitemize}
\item \textbf{P.Das}, A.Basareh, A.Pelenitsyn, K.Sundararajah, M.Kulkarni, B.Delaware, {\href{https://arxiv.org/abs/2407.00829}{``Bring Your Own Formats and Kernels: Composable Abstractions for Sparse Matrix Computation''}}.
\end{tightitemize}
