...
\Section{Education}
\vspace{-4pt}
\EducationEntry{\textbf{Purdue University}}{August, 2021 - Present}{PhD in Computer Science (Advisor - Milind Kulkarni)}{
    \vspace{-10pt}
...
\ExperienceEntry{\textbf{{\href{https://iris-hep.org/}{IRIS-HEP}} - Fellow}}{June, 2020 - September, 2020}{Princeton University}{Supervisor - Jim Pivarski}{
    ...
    \item \href{https://github.com/scikit-hep/awkward-1.0}{Awkward Array}: Library for nested, variable-sized data using NumPy-like idioms
        \subitem - Implemented a source to source compiler to generate equivalent Python for a subset of C++.
        \subitem - Designed a property based testing framework.
        \subitem - Created a source to source compiler to generate equivalent parallel CUDA from specification (Python and type info).
        \subitem - Enabled automatically parallization of ...
	\end{tightitemize}
} \vspace{4pt}\\
...
\begin{tightitemize}
\item \textbf{P.Das}, A.Dias, A.Xhebraj, A.Pelenitsyn, K.Sundararajah, M.Kulkarni, {\href{https://arxiv.org/abs/2407.00829}{``SABLE: Staging Blocked Evaluation of Sparse Matrix Computations''}}.
\end{tightitemize}
...
\vspace{-4pt}
\textbf{CS 307: Software Engineering} - Purdue University \hfill{Spring 2024}
...
\Section{Service}
\begin{tightitemize}
\item Purdue Programming Languages group (PurPL) co-ordinator \hfill 2024 - Present
