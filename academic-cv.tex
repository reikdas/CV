...
\usepackage{pbox}
\usepackage{needspace} % keep section headers with their content
...
\PersonalEntry{\textbullet{} Website}{\href{https://reikdas.github.io}{reikdas.github.io}}
\end{spacing}
\vspace{-13pt}
...
\Section{Education}
\vspace{-4pt}
\EducationEntry{\textbf{Purdue University}}{August, 2021 - May, 2027 (Expected)}{PhD in Computer Science (Advisors - Milind Kulkarni, Ben Delaware)}{
    \vspace{-10pt}
...
\Section{Experience}
\vspace{-4pt}
\ExperienceEntry{\textbf{ML Performance (Google Cloud) - Student Researcher}}{May, 2026 - August, 2026}{Google}{}{
    \vspace{-23pt}
    \begin{tightitemize}
        \item XLA TPU compiler: Built out an XLA plugin estimating TPU cycles of HLO ops without actually running on TPUs
            \subitem - Broadened HLO op coverage (e.g. all-reduce) and added support for more LLO emitters (pipeline, collectives).
            \subitem - Reduced delta against measured TPU runs on Goose, Gemini, and YouTube workloads from over 50\% to $\sim$5\%.
            \subitem - Sped up static estimation by implementing compiler passes such as loop fast-forwarding.
        \end{tightitemize}
}\vspace{4pt}\\
\ExperienceEntry{\textbf{SwiftUI - Compiler Intern}}{May, 2023 - August, 2023}{Apple}{}{
    \vspace{-23pt}
    \begin{tightitemize}
        \item Swift compiler: Extended the compiler and runtime to retarget SwiftUI to a new IR
            \subitem - Extended Swift's code generation and runtime, with LLVM patches, to lower SwiftUI to a new target IR.
            \subitem - Integrated an interpreter into Swift's runtime, enabling live updates of SwiftUI views from newly loaded code.
            \subitem - Implemented dynamic loading and symbol resolution of system shared libraries for interpreted code.
        \end{tightitemize}
}\vspace{4pt}\\
...
\ExperienceEntry{\textbf{{\href{https://iris-hep.org/}{IRIS-HEP}} - Fellow}}{June, 2020 - September, 2020}{Princeton University}{Supervisor - Jim Pivarski}{
    ...
    \item \href{https://github.com/scikit-hep/awkward-1.0}{Awkward Array}: Library for nested, variable-sized data using NumPy-like idioms
        \subitem - Implemented a source-to-source compiler from a C++ subset to equivalent Python, with property-based testing.
        \subitem - Created a source-to-source compiler to generate equivalent parallel CUDA from specification (Python and type info).
        \subitem - Enabled automatic parallelization of user-written Awkward Array kernels.
	\end{tightitemize}
} \vspace{4pt}\\
...
\begin{tightitemize}
\item \textbf{P.Das}, A.Basareh, A.Pelenitsyn, K.Sundararajah, M.Kulkarni, B.Delaware, {\href{https://arxiv.org/abs/2407.00829}{``Bring Your Own Formats and Kernels: Composable Abstractions for Sparse Matrix Computation''}}, IEEE/ACM International Symposium on Code Generation and Optimization (CGO, 2027).
\item \textbf{P.Das}, A.Xhebraj, T.Rompf, {\href{https://www.cs.purdue.edu/homes/rompf/papers/das-gpce24.pdf}{``Specializing Data Access in a Distributed File System (Generative Pearl)''}}, 23rd ACM SIGPLAN International Conference on Generative Programming: Concepts and Experiences (GPCE, 2024), DOI: https://doi.org/10.1145/3689484.3690736.
\item T.Mustafa, K.Kallas, \textbf{P.Das}, N.Vasilakis, {\href{https://www.usenix.org/conference/nsdi23/presentation/mustafa}{``DiSh: Dynamic Shell-Script Distribution''}}, 20th USENIX Symposium on Networked Systems Design and Implementation (NSDI, 2023).
...
\vspace{-4pt}
\textbf{CS 307: Software Engineering} - Purdue University \hfill{Spring 2025, Fall 2025}

\textbf{CS 354: Operating Systems} - Purdue University \hfill{Fall 2022 - Fall 2024, Spring 2026}
...
\vspace{-4pt}
\textbf{Experienced:} Python, CUDA, XLA

\textbf{Familiar:} C, C++, Java, Scala, Coq, Bash, \LaTeX, Swift, WebAssembly, MLIR
\vspace{-6pt}
...
\small{\begin{tightitemize}
\item Staging Blocked Evaluation of Sparse Matrix Computations (\href{https://purduepl.github.io/seminars/2026/2026-4-16-seminar}{PurPL Seminar}) \hfill{2026}
