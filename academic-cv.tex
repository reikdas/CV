...
\Section{Education}
\vspace{-4pt}
\EducationEntry{\textbf{Purdue University}}{August, 2021 - Present}{PhD in Computer Science (Advisors - Milind Kulkarni, Ben Delaware)}{
    \vspace{-10pt}
...
\ExperienceEntry{\textbf{ML Performance (Google Cloud) - Student Researcher}}{May, 2026 - August, 2026}{Google}{}{
    \vspace{-23pt}
    \begin{tightitemize}
        \item XLA TPU compiler: Built out a \textit{fast} static profiler plugin estimating cycles from LLO graphs without running on TPUs
            \subitem - Broadened HLO operation coverage (e.g. all-reduce) and added support for pipeline and collective emitters.
...
\ExperienceEntry{\textbf{SwiftUI - Compiler Intern}}{May, 2023 - August, 2023}{Apple}{}{
    \vspace{-23pt}
    \begin{tightitemize}
        \item Swift compiler: Worked on the Swift compiler motivated by SwiftUI
...
\ExperienceEntry{\textbf{Google Summer of Code - Student}}{June, 2021 - August, 2021}{The LLVM Compiler Infrastructure Organization}{Supervisors - William Moses, Johannes Doerfert}{
    ...
    \item \href{https://enzyme.mit.edu/}{Enzyme}: LLVM Pass to perform automatic differentiation of statically analyzable LLVM IR
        \subitem - Integrated custom derivatives of several BLAS (Basic Linear Algebra Subprograms) functions into Enzyme.
