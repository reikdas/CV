...
\Section{Education}
\vspace{-4pt}
\EducationEntry{\textbf{Purdue University}}{2021 -}{PhD in Computer Science (Advisor - Tiark Rompf). GPA: 3.77/4.0}{
    \vspace{-10pt}
    \begin{tightitemize}
        \item Courses - Operating Systems, Programming Languages, Advanced Topics in Compilers
    \end{tightitemize}
  }\\
...
\vspace{-4pt}
\ExperienceEntry{\textbf{CS 240: Programming in C}}{Fall 2021, Spring 2022}{Purdue University}{Instructed lab sessions, held office hours, graded assignments and exams}{}\vspace{-23pt}
...
\vspace{-4pt}
%\ExperienceEntry{\textit{Supervisors} - Dr. Nikos Vasilakis (MIT), Konstantinos Kalas (UPenn)}{February, 2022 - }{}{\textit{Collaborators}: MIT, UPenn, Stevens Institute of Technology}{
%    \vspace{-10pt}
%    \begin{tightitemize}
...
\textbf{Familiar:} C++, Java, Scala, Coq, ROOT, BaSH
\vspace{-6pt}
